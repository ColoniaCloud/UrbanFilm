...
const CARDS = [
  {
    ...
    text: 'IR superior al promedio económico del mercado. Tu cliente siente la diferencia desde el primer día.',
    paths: [
  ...
  },
  {
    ...
    text: 'Color propio en la lámina para una visibilidad óptima. Sin desteñir, sin perder rendimiento.',
    paths: [
  ...
  },
  {
    ...
    text: 'Acabado uniforme y consistente. Fácil de instalar, resultado profesional garantizado.',
    paths: [
  ...
  },
  {
    id: 'uv',
    title: 'Protección UV',
    text: 'Bloqueo efectivo de rayos UV. Un argumento de venta concreto para cerrar más trabajos.',
    paths: [
